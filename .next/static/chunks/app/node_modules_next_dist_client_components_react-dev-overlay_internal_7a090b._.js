    ...
    return frames.map((frame)=>{
        try {
            ...
            if (res) {
                ...
                const distDir = (_process_env___NEXT_DIST_DIR = ("TURBOPACK compile-time value", JSON.parse('"D:\\\\Studying\\\\Projects\\\\GIT\\\\Blog\\\\.next"'))) == null ? void 0 : (_process_env___NEXT_DIST_DIR_replace = _process_env___NEXT_DIST_DIR.replace(/\\/g, "/")) == null ? void 0 : _process_env___NEXT_DIST_DIR_replace.replace(/\/$/, "");
                if (distDir) {
